            ...
            <div class="col-span-full">
                <div class="card p-0">
                    <div class="flex-center-between p-6 pb-4 border-b border-gray-200 dark:border-dark-border">
                        <h3 class="text-lg card-title leading-none">All Users Withdrawal History</h3>
                        ...
                        <div class="overflow-x-auto mt-5">
                            <table
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="6" class="p-6 py-4 text-center">No Users Withdraw history
                                                available.
                                            </td>
                                        </tr>
                                    @endif
                        ...
                        <div class="overflow-x-auto mt-5">
                            <table
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-dark-border-three">
                                    @if ($withdrawals->isNotEmpty())
                                        @foreach ($withdrawals as $withdrawal)
                                            <tr>
                                                <td class="p-6 py-4">{{ $withdrawal->id }}</td>
                                                <td class="p-6 py-4">{{ $withdrawal->transaction_id }}</td>
                                                <td class="p-6 py-4">{{ $withdrawal->user->name }}</td>
                                                <td class="p-6 py-4">${{ $withdrawal->amount ?? 'N/A' }}</td>

                                                <td class="p-6 py-4">{{ $withdrawal->crypto_name }}</td>
                                                <td class="p-6 py-4">{{ $withdrawal->network }}</td>
                                                <td class="p-6 py-4">{{ $withdrawal->crypto_address }}</td>
                                                ...
                                                <td class="p-6 py-4">
                                                    <form action="{{ route('admin.withdraw-status', $withdrawal->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('PUT')
                                    ...
                                    @else
                                        <tr>
                                            <td colspan="6" class="p-6 py-4 text-center">No withdrawal history
                                                available.</td>
                                        </tr>
                                    @endif
                                </tbody>
