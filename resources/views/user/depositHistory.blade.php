            ...
            <div class="col-span-full">
                <div class="card p-0">
                    <div class="flex-center-between p-6 pb-4 border-b border-gray-200 dark:border-dark-border">
                        <h3 class="text-lg card-title leading-none">Deposit History</h3>
                                    ...
                                    @if ($deposits->isNotEmpty())
                                        @foreach ($deposits as $deposit)
                                            <tr>
                                                ...
                                                <td class="p-6 py-4">{{ $deposit->amount }}</td>

                                                <td class="p-6 py-4">
                                                    <span
                                                        class="badge badge-success-light rounded-full">{{ $deposit->status }}</span>
                                                </td>
