...
<body class="bg-body-light dark:bg-dark-body">
    ...
    <script src="/dash/js/vendor/flowbite.min.js"></script>
    <script src="/dash/js/vendor/smooth-scrollbar/smooth-scrollbar.min.js"></script>
    <script src="/dash/js/component/app-menu-bar.js"></script>
